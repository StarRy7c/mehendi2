...
odoo.define('@website/js/content/generate_video_iframe',[],function(require){'use strict';let __exports={};const SUPPORTED_DOMAINS=["youtu.be","youtube.com","youtube-nocookie.com","instagram.com","player.vimeo.com","vimeo.com","dailymotion.com","player.youku.com","youku.com",];__exports.escape=escape;function escape(str){if(!str){return"";}
